...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color:#0a0f2e;">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <?php endif ?>
    	...
    	<p> <a href="index.php?logout='1'" class="btn btn-outline-success my-5 my-sm-0" style="color: white;">logout</a> </p>
  </div>
</nav>
<!-- Navigation bar end  -->
  ...
  <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample" style="background-color:#0a0f2e">
  <i class="fa fa-plus"></i> Add New Card
  </button>
  <a href="id-card.php" class="btn btn-primary" style="background-color:#0a0f2e">
...
<div class="collapse" id="collapseExample">
  <div class="card card-body">
    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-4">
        ...
        <select name="grade" class="form-control">
          ...
          <option value="1st">100</option>
          <option value="2nd">200</option>
          <option value="3rd">300</option>
          <option value="4th">400</option>
          <option value="5th">500</option>
        </select>
      </div>
    ...
    <div class="form-row">
      <div class="form-group col-md-6">
        <label for="inputCity">Faculty and Department</label>
      ...
      <button type="submit" class="btn btn-primary" style='background-color:#0a0f2e'><i class="fa fa-plus"></i> Add Card</button>
    </form>
  </div>
</div>
      ...
      <tbody>
        <?php 
          ...
          while($row = mysqli_fetch_assoc($result)){
            ...
            <td>". $row['name'] . "</td>
            <td>". $row['id_no'] . "</td>
            <td> <button class='edit btn btn-sm btn-primary' style='background-color:#0a0f2e' id=".$row['sno'].">Edit</button> 
            <button class='delete btn btn-sm btn-primary' style='background-color:#0a0f2e' id=d".$row['sno'].">Delete</button>  
            </td>
          </tr>";
        } 
          ?>
    ...
    Array.from(deletes).forEach((element) => {
      element.addEventListener("click", (e) => {
        ...
        if (confirm("Are you sure you want to delete this note!")) {
          console.log("yes");
          window.location = `display.php?delete=${sno}`;
