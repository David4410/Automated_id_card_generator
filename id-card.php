               ...
               $html.="";
                         while($row=mysqli_fetch_assoc($result)){
                            ...
                            $date = date('M d, Y', strtotime($row['date']));
                             ...
                             $html.="
                                        <!-- second id card  -->
                                        <div class='container' style='text-align:left;background-color: #0a0f2e; border:2px dotted black;'>
                                              <div class='header'>
                                              ...
                                              <div class='container-2'>
                                                  ...
                                                  <div class='box-2'>
                                                      <h2 style='color:white; text-transform: uppercase'>$name</h2>
                                                      <p style='font-size: 16px; text-transform: uppercase; color:white'> Student </p>
                                                  </div>
                                                  <div class='box-3'>
                                              ...
                                              <div class='container-3'>
                                                  ...
                                                  <div class='info-2'>
                                                      ...
                                                      <div class='expire-date'>
                                                          <h4>Expire Date</h4>
                                                          <p style='color:white'>$exp_date</p>
                                                      </div>
                                                  </div>
                                                  <div class='info-3'>
                                                      <div class='email'>
...
<html lang="en">
  <head>
    ...
    <title> Automated Student ID Card Generator </title>
...
<hr>
<button id="demo" class="downloadtable btn btn-primary" style='background-color:#0a0f2e' onclick="downloadtable()"> Download and Print Id Card</button>
    <!-- Optional JavaScript -->
